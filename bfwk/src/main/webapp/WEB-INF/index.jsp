...
<body>
    ...
    <a href="/frame/toinfo" target="rightFrame">帐号设置</a>
    </div>
    
    <div class="welinfo">
    <span><img src="${app}/static/images/time.png" alt="时间" /></span>
    ...
    <li><img src="${app}/static/images/ico01.png" /><p><a href="#">管理设置</a></p></li>
    <li><img src="${app}/static/images/ico02.png" /><p><a href="#">发布文章</a></p></li>
    <li><img src="${app}/static/images/ico03.png" /><p><a href="#">数据统计</a></p></li>
    <li><img src="${app}/static/images/ico04.png" /><p><a href="#">文件上传</a></p></li>
    <li><img src="${app}/static/images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="${app}/static/images/ico06.png" /><p><a href="#">查询</a></p></li> 
    ...
    <div class="welinfo">
    <span><img src="${app}/static/images/dp.png" alt="提醒" /></span>
    <b>信息管理系统使用指南</b>
    </div>
